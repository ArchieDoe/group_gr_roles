 ...
 */
class GroupGrMembership implements CacheableDependencyInterface {
   ...
   *   GroupContent entity tha1t was not based on the GroupMembership content
   *   enabler plugin.
   */
  public function __construct(GroupContentInterface $group_content) {
    if ($group_content->getGroupContentType()->getContentPluginId() == 'group_gr_membership') {
