...
namespace Drupal\group_gr_roles;
 ...
 */
class GroupGrMembershipLoader implements GroupMembershipLoaderInterface {
  ...
  protected function wrapGroupContentEntities($entities) {
    ...
    foreach ($entities as $group_content) {
      $group_memberships[] = new GroupGrMembership($group_content);
    }
  ...
  public function load(GroupInterface $group, AccountInterface $account) {
    ...
    $group_contents = $this->groupContentStorage()->loadByGroup($group, 'group_gr_membership', $filters);
  ...
  public function loadByGroup(GroupInterface $group, $roles = NULL) {
    ...
    if (isset($roles)) {
      $filters['group_gr_roles'] = (array) $roles;
    }
  ...
  public function loadByUser(AccountInterface $account = NULL, $roles = NULL) {
    ...
    $group_content_types = $this->entityTypeManager
      ...
      ->loadByProperties(['content_plugin' => 'group_gr_membership']);
    ...
    if (isset($roles)) {
      $properties['group_gr_roles'] = (array) $roles;
    }
